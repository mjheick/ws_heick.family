...
CREATE TABLE `family` (
  ...
  `parent-adopt-a` int(10) unsigned NOT NULL DEFAULT 0,
  `parent-adopt-b` int(10) unsigned NOT NULL DEFAULT 0,
...
-- Dump completed on 2022-08-22  2:09:39
